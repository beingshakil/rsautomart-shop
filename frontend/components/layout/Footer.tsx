        ...
        <div>
          ...
          <div className="mt-6 flex items-center gap-3">
            {[
              ...
              { label: 'Tiktok', href: 'https://www.tiktok.com/@rs.automart', svg: 'M16 4H8a4 4 0 00-4 4v8a4 4 0 004 4h8a4 4 0 004-4V8a4 4 0 00-4-4zm-4 11a3 3 0 110-6 3 3 0 010 6zm4.5-7.5a1 1 0 110-2 1 1 0 010 2z' }
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li className="flex flex-col gap-1">
              ...
              <span className="text-sm text-gray-400 font-semibold tracking-wide">70 ৳ (Standard Delivery)</span>
            </li>
            <li className="flex flex-col gap-1">
