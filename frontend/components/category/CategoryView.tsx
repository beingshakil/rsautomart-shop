...
export default function CategoryView({ categorySlug, initialCategoryData }: { categorySlug: string, initialCategoryData?: any }) {
  const [categoryId, setCategoryId] = useState<string | null>(initialCategoryData?._id || null);
  const [categoryData, setCategoryData] = useState<any>(initialCategoryData || null);
  ...
  }, [categorySlug, initialCategoryData]);
