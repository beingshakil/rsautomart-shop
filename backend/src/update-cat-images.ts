...
const updateCategoryImages = async () => {
  try {
    ...
    const mapping: Record<string, string> = {
      'car-accessories': 'RSA-0012', // Bangladesh Flag Stand
      'car-care': 'RSA-0007',        // DTR Glass Cleaner
      'electronics': 'RSA-0001',      // Quick Charge Car Charger
      'interior': 'RSA-0003',         // Car Console Organizer
      'collectibles': 'RSA-0002',     // Diecast Jeep Wrangler
      'cooling-comfort': 'RSA-0008',   // Car Seat Cooling Fan
    };
